    ...
    <div className="bg-black flex items-center p-6 h-screen w-screen">
      <div className="rounded-lg mr-6 h-full w-20 bg-white bg-opacity-10 flex flex-col items-center justify-between">
        <div className="flex flex-col items-center justify-between">
          ...
          <button className={key=="/"?"flex justify-center items-center w-full p-4 bg-gradient-to-r from-zinc-500 to-transparent border-l-4 border-white":"p-4 opacity-40 hover:opacity-100 focus:bg-white"} onClick={() => router.push('/admin')}>
