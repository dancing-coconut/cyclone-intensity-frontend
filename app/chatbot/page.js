        ...
        <div className="bg-black flex items-center p-6 h-screen w-screen">
          ...
          <div className="flex items-center rounded-lg h-full">
            <div className='flex flex-col h-full'>
              <div className='h-30 bg-white bg-opacity-20 rounded-lg text-white text-center p-2 w-96 mb-4 mr-6'>NOTED QUESTIONS</div>
              <div className="bg-white h-full bg-opacity-10 rounded-lg w-96 mr-6 overflow-scroll p-4 text-center">
                {Object.keys(data).length === 0 ? <div className='opacity-30 w-full border border-white rounded-lg p-2'>There are no noted questions yet!</div>:""}
